...
class PackageViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        for item in products:
            ...
            try:
                product = Product.objects.get(name=name)  # Fetch by name
                ...
                return Response({"error": f"Product with name '{name}' does not exist"},
        ...
        with transaction.atomic():
            ...
            for item in products:
                product = Product.objects.get(name=item["name"])  # Fetch by name
